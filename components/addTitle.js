  ...
  return (
    <>
      <div className='container shadow rounded-lg p-4 my-3 flex-row flex items-center cursor-default bg-white'>
        ...
        <input className='sm:mr-10 mx-3 w-20 sm:w-32 md:w-80 bg-white border-gray-200 border-b-2 p-1 outline-none focus:outline-none hover:border-red-200 focus:border-red-500 cursor-auto'></input>
      </div>
    </>
  )
}